#!/bin/bash
# most of these are commented out... there's no good reason to use them, but might be handy for some folks to know where to get the rest of ULS...
# I leave GMRS in as many hams are GMRS licensees as well and it'd be nice to be able to pull up their other licenses too...
#mkdir -p db
#cd db
#cp ../sql/*.sql .
#[ ! -f fcc_uls_fixed.sql ] && {
